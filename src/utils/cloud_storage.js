...
const storage = new Storage({
    projectId: "proyectoapp-4e075",
    keyFilename: './serviceAccountKey.json' //es el que enlaza el servidor con firebase
});

const bucket = storage.bucket("gs://proyectoapp-4e075.appspot.com/");
